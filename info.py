...
API_ID = int(environ.get('API_ID', '20301415'))
API_HASH = environ.get('API_HASH', 'f437d50de35414db31347a998e7f857f')
BOT_TOKEN = environ.get('BOT_TOKEN', "6823826122:AAEFDg0KWb0p1vtbbfckTau83pRjyLkvSC8") #if you are going to bot token here make sure your repo is private..
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5863661087').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001577956475').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001635800175')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001980108407')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://brandedclap1:brandedclap1@cluster0.qhl4t7a.mongodb.net/?retryWrites=true&w=majority
")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/vibecasmsupport
')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/vibecasm1')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Movie_Url_link_downloader/17')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Kʏᴀ ʀᴇ Bhikmanga 😑,Kʏᴀ Dekh Raha Hai ?')

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001513759896'))
VERIFY_REQ_CHNL = int(environ.get('VERIFY_REQ_CHNL', ''))
NEW_USER_LOG = int(environ.get('NEW_USER_LOG', '-1001513759896'))
BIN_CHNL = int(environ.get('BIN_CHNL', '-1001513759896'))

SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'vibecasmsupport
')
